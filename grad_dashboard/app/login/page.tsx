    ...
    <div className="h-screen flex items-center justify-center bg-gradient-to-t from-white to-blue-100">
        <div className="bg-white p-10 rounded-lg shadow-md">
            ...
            <div id="login_input" className="mt-10">
                ...
                <input name="first_name" className="mt-2 outline-none w-[300px] text-sm text-slate-700 border-[1.2px] rounded-lg shadow-sm px-2 py-2 focus:outline-blue-400" placeholder="example@email.com"/>
            ...
            <div className="flex flex-col justify-between gap-y-4">
                <button className="px-4 py-2 border flex gap-2 border-slate-200 bg-slate-700 rounded-lg hover:border-slate-200 hover:text-slate-900 hover:shadow transition">
